...
<body class="bg-stream-dark">
    ...
    <div class="grid md:grid-cols-12 font-poppins relative pb-20">
        ...
        <span class="fixed -z-10 top-0">
            <img src="{{asset('assets/images/pricing_ornament.svg')}}" class="h-screen w-screen" alt="stream" />
        </span>
        <!-- ./ -->
                ...
                <div class=" flex flex-row justify-between items-center relative">
                    ...
                    <div class="collapsible-dropdown flex flex-col gap-2 relative">
                        <a href="#!"
                            ...
                            <img src="{{asset('stream/assets/images/photo.webp')}}" class="rounded-full object-cover w-full" alt="stream" />
                        </a>
