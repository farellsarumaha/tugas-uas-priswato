    ...
    <div class="col-md-12">
      <div class="card card-primary">
        ...
        <div class="card-body">
          <div class="row">
            <div class="col-md-12">
              <a href="{{Route('admin.movie.create')}}" class="btn btn-warning">Buat film</a>
            </div>
          </div>
              ...
              <table id="movie" class="table table-bordered table-hover">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{$movie->title}}</td>
                        <td>
                            <img src="{{asset('storage/thumbnail/'.$movie->small_thumbnail)}}" width="60%"   >
                        </td>
                        <td>
                            <img src="{{asset('storage/thumbnail/'.$movie->large_thumbnail)}}" width="60%"   >
                        </td>
